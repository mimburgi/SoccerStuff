...
TeamA3pass<-read.csv('./2018/ASAteampassingtable_A3.csv', stringsAsFactors = F)
TeamM3pass<-read.csv('./2018/ASAteampassingtable_M3.csv', stringsAsFactors = F)
TeamD3pass<-read.csv('./2018/ASAteampassingtable_D3.csv', stringsAsFactors = F)
Teamshoot<-read.csv('./2018/ASAteamshooter.csv', stringsAsFactors = F)
Teamtotalpass<-read.csv('./2018/ASAteampassingtable_total.csv', stringsAsFactors = F)
...
poss<-read.csv('./2018/FBRef-Possession.csv', stringsAsFactors = F)
passtype<-read.csv('./2018/FBRef-PassType.csv')
fbshoot<-read.csv('./2018/FBRef-Shoot.csv')
fbpass<-read.csv('./2018/FBRef-Pass.csv')
...
poss<-poss[poss$Player!='Dominic Oduro',]
...
passtype<-passtype[passtype$Player!='Steve Clark',]
passtype<-passtype[passtype$Player!='Dominic Oduro',]
...
fbshoot<-fbshoot[fbshoot$Player!='Steve Clark',]
fbshoot<-fbshoot[fbshoot$Player!='Dominic Oduro',]
...
fbpass<-fbpass[fbpass$Player!='Steve Clark',]
...
fbref_matchnames$Player[fbref_matchnames$Player=='Ismael Tajouri Shradi']<-'Ismael Tajouri'
fbref_matchnames$Player[fbref_matchnames$Player=='Chris Durkin']<-'Christopher Durkin'
fbref_matchnames$Player[fbref_matchnames$Player=='Mohamed El Monir']<-'Mohamed El-Munir'
fbref_matchnames$Player[fbref_matchnames$Player=='Alejandro Silva Gonzalez']<-'Alejandro Silva'
fbref_matchnames$Player[fbref_matchnames$Player=='Bismark Adjei Boateng']<-'Bismark Boateng'
fbref_matchnames$Player[fbref_matchnames$Player=='David Romney']<-'Dave Romney'
...
## write out ####
dat$Player[dat$Player=='Gerso Fernandes']<-'Gerso'
dat$Player[dat$Player=='Steve Birnbaum']<-'Steven Birnbaum'
dat$Player[dat$Player=='Adam Lundqvist']<-'Adam Lundkvist'

write.table(dat, '2018summary.txt', row.names = F)
