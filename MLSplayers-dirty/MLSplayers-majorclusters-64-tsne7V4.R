...
set.seed(250)
tsne<-Rtsne::Rtsne(bothscaled, perplexity=39)$Y
plot(tsne)
...
#11
set.seed(20)
clara11<-clara(tsne, 11)
set.seed(20)
km11<-kmeans(tsne, 11, nstart = 11)
set.seed(20)
pam11<-kmeans(tsne, 11)
set.seed(20)
hk11<-hkmeans(tsne, 11)
set.seed(20)
hk112<-hkmeans(tsne, 11, hc.method = 'complete')
set.seed(20)
hc11<-hclust(dist(tsne), method = 'ward.D2')%>% cutree(11)
set.seed(20)
hc112<-hclust(dist(tsne), method = 'complete')%>% cutree(11)
...
compclusts<-as.factor(km11$cluster) #69.7
# compclusts<-as.factor(clara11$cluster) 
# compclusts<-as.factor(pam11$cluster) 
# compclusts<-as.factor(hk11$cluster) #68.6
# compclusts<-as.factor(hk112$cluster) #69.2
# compclusts<-as.factor(hc11) #68.6
# compclusts<-as.factor(hc112) #67
