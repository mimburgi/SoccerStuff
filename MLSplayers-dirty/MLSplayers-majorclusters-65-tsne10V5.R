...
set.seed(25)
tsne<-Rtsne::Rtsne(bothscaled, perplexity=26)$Y 
plot(tsne)
...
compclusts<-as.factor(clara$clustering) #77
...
## name cluster levels ####
levels(compclusts)<-c('DLP', 'B2B Buildup/DFB', 
                      'Creator', 'Complete Attacker',
                      'BPD', 'MF Outlet', 
                      'MF Recycler', 'B2B & Cross', 
                      'Finisher', 'Defensive Outlet')
