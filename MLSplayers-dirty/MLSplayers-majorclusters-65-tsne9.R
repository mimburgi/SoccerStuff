...
set.seed(25)
tsne<-Rtsne::Rtsne(bothscaled, perplexity=20)$Y 
plot(tsne)
...
## name cluster levels ####
levels(compclusts)<-c('MF Orchestrator', 'MF Ball Protector', 'Attacking Shuttler',
                      'Attacking Hub','Buildup Shuttler', 'BPD',
                      'Hybrid Attacker', 'Defender', 'Finisher')
